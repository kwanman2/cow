...
#define PRODUCTION 2 // jane: 1 for normal test run; 2 for supercomputer
...
#define N1 128 // KORALTODO: 512 in paper
#define N2 8
#define N3 4
...
#undef DOCOMPTON
#define DOCOMPTON 1 // enable thermal Comptonization        //tom: keep this
...
//#define WHICHRADSOURCEMETHOD SOURCEMETHODNONE
//#define WHICHRADSOURCEMETHOD SOURCEMETHODEXPLICIT
#define WHICHRADSOURCEMETHOD SOURCEMETHODIMPLICIT           //tom: keep this
...
#define N1 8        //tom: N123=8 low resolution runs, not possible to further tune down
#define N2 8
#define N3 8 //jane: mid resolution runs  tom: tianhe-2
...
#undef MPERSUN
#define MPERSUN (1E4) //tom: IMBH mass, cow

#undef RADIUSMOREDEATH
#define RADIUSMOREDEATH (300.0)     //tom: keep this
